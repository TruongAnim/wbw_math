...
class Scene1(MyScene):
    def construct(self):
        ...
        self.my_play(Write(day))
        self.my_play(Write(p))
        self.my_play(Write(goi), Write(M))
        self.my_play(Write(M1))
        self.my_play(Write(M2))
        self.my_play(Write(M3))
        self.my_play(Write(M4))
        self.my_play(Write(math1), Write(text1))
        self.my_play(p[0][-1].animate.shift(RIGHT))
        x = MathTex(", X", color=RED).next_to(p[0][-3], RIGHT)
        self.my_play(Write(x))
...
class Scene2(MyScene):
    def construct(self):
        ...
        self.my_play(Write(M3))
        self.my_play(Write(M4))
        self.my_play(Write(M5))
        self.my_play(Write(math1), Write(text1))
        x2 = MathTex(r"=59 \times 509", color=RED).next_to(M, RIGHT)
        self.my_play(Write(x2))
        self.my_play(p[0][-1].animate.shift(RIGHT*1.7))
...
class Scene3(MyScene):
    def construct(self):
        ...
        self.my_play(Write(title1))
        self.my_play(Write(title2))
        self.my_play(FadeIn(M, shift=UP), FadeIn(condition, shift=UP))
        self.my_play(FadeIn(brace, shift=LEFT))
        self.my_play(Write(text1))
        self.my_play(Write(text2))
